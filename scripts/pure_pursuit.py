...
class pure_pursuit:
    ...
    def callback(self,data):
        ...
        xx_trans = self.path_points_x[self.goal]* math.cos(yaw)
        xy_trans = -self.path_points_y[self.goal]* math.sin(yaw)
        yx_trans = self.path_points_x[self.goal]* math.sin(yaw)
        yy_trans = self.path_points_y[self.goal]* math.cos(yaw)
